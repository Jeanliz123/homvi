  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#d4af37]/30 font-sans">
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <div className="bg-[#0a0a0a] border border-white/10 rounded-3xl p-8 shadow-2xl shadow-[#d4af37]/5 text-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div><p className="text-3xl font-light">$18B</p><p className="text-gray-500 text-[10px] uppercase tracking-widest mt-2">Gestionados</p></div>
            <div><p className="text-3xl font-light">2.4k</p><p className="text-gray-500 text-[10px] uppercase tracking-widest mt-2">Agentes</p></div>
            <div><p className="text-3xl font-light">98%</p><p className="text-gray-500 text-[10px] uppercase tracking-widest mt-2">Retención</p></div>
            <div><p className="text-3xl font-light">+34%</p><p className="text-gray-500 text-[10px] uppercase tracking-widest mt-2">Ventas</p></div>
          </div>
        </div>
      </section>
