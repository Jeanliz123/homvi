    ...
    <div className="p-8 ml-64 bg-black min-h-screen text-white font-sans">
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button className="bg-amber-500 hover:bg-amber-600 text-black px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 shadow-[0_0_20px_rgba(245,158,11,0.2)]">
      ...
      <div className="relative mb-8">
        ...
        <input 
          ...
          className="w-full bg-zinc-900/30 border border-zinc-800/50 rounded-xl py-4 pl-12 pr-4 text-sm focus:outline-none focus:border-amber-500/50 transition-all placeholder:text-zinc-600"
        />
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {clients.map((client) => (
          <div key={client.id} className="bg-zinc-900/40 border border-zinc-800/60 p-6 rounded-2xl hover:border-amber-500/40 transition-all group cursor-pointer">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className={`text-[10px] font-bold px-2 py-1 rounded-md border ${
                ...
                client.status === 'EN OFERTA' ? 'text-amber-500 border-amber-500/20 bg-amber-500/5' :
